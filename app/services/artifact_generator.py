...
class ArtifactGenerator:
    ...
    def _generate_windows_dockerfile(self) -> str:
        ...
        base_image = (
            self.migration.base_image or "mcr.microsoft.com/windows/servercore:ltsc2022"
        )
    ...
    def generate_kubernetes_manifest(self) -> str:
        ...
        deployment = {
            ...
            "metadata": {
                "name": app_name,
                "namespace": namespace,
                "labels": {"app": app_name, "migrated-from": "vmshift"},
            },
            "spec": {
                "replicas": replicas,
        ...
        service = {
            "apiVersion": "v1",
            "kind": "Service",
            "metadata": {"name": f"{app_name}-service", "namespace": namespace},
            "spec": {
